...
| 004 | `contas-avatar` (001, 002) | Cadastro em 2 passos (avatar → dados pessoais), login, Minha Conta (avatar + skills), construtor de avatar pixel art, LGPD, **e o `LikeButton` com o convite de conta — a metade de clique de FR-015 da 003, movida para cá pela CLR-010 (2026-09-09), porque o convite existe para iniciar o cadastro que esta feature constrói** | product/pages/onboarding.md, product/pages/minha-conta.md, product/pages/login.md |
