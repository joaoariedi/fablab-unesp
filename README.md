...
**CRIE. EXPERIMENTE. TRANSFORME.** This repository builds the official website of
...
classes, publishing projects, 3D models and articles, levels up **skills** (3D modeling,
...
| **Projetos / Artigos** | Galleries of maker-built projects and articles, filterable, with author attribution |
...
| 002 | `cms-conteudo` | Collections, multi-format uploads (presigned + post-upload validation), moderation |
...
The project is documentation-first — the docs are the contract:
