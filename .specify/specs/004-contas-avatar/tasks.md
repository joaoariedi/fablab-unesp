...
32 tasks over 7 phases, ordered by **risk and by what unblocks what** — not by FR number. The
...
| T038 | The signed-in isolation vantage point across every page this feature adds | FR-029, SC-007 | `apps/web/tests/tenancy/signed-in.test.ts` | T034 |
