...
Three collections: two global (`organizations`, `users`) and one scoped canary that gives
the guardrails a subject (FR-028). Content collections arrive in feature 002 — they inherit
the tenancy shape defined here, which is why this feature must land first
