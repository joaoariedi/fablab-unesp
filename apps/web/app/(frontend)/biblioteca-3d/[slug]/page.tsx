...
import { AUTOR_REMOVIDO, Chip, formatHandle, ModelViewer } from '@fablab/ui'
...
/**
 * The author line: the maker the model credits, the tombstone when they deleted their account,
 * or nothing when the profile did not arrive. Not a link — the public maker profile is a future
 * spec (004/005), and an anchor to a route this feature does not create is a 404 the mockup did
 * not ask for.
 *
